...
|---------|------------|--------------|-------------------|---------------|--------------|
| 1-2 | تنظيم الاجتماعات | تعلم Arduino IDE | دراسة المكونات | تصميم المخططات | بحث بيئي |
| 3-4 | متابعة التقدم | كتابة كود تجريبي | ربط دوائر بسيطة | بناء الهيكل | تقييم المواد |
| 5-6 | حل المشاكل | برمجة الحساسات | اختبار التوصيلات | دمج الإلكترونيات | حساب التوفير |
| 7-8 | تحضير العرض | تحسين الكود | فحص نهائي | اللمسات الأخيرة | إعداد التقرير |
