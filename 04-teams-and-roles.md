...
**المسؤوليات الأساسية:**
- ⌨️ كتابة الكود للوحة ESP32
- 🔧 برمجة الحساسات والمحركات
...
- 🎨 تصميم الشكل الخارجي والداخلي
- 📏 ضمان ثبات واستقرار النموذج
- 🔄 دمج المكونات الإلكترونية مع التصميم
- 📸 توثيق مراحل البناء بالصور

**المهارات المطلوبة:**
- حس جمالي وإبداعي
- مهارات هندسية أساسية
- قدرة على التصور المكاني
- دقة في القياسات
...
## جدول توزيع المسؤوليات الأسبوعية 📅

| الأسبوع | قائد الفريق | مهندس البرمجة | مهندس الإلكترونيات | مهندس التصميم | مسؤول البيئة |
|---------|------------|--------------|-------------------|---------------|--------------|
| 1-2 | تنظيم الاجتماعات | تعلم Arduino IDE | دراسة المكونات | تصميم المخططات | بحث بيئي وطاقة شمسية |
| 3-4 | متابعة التقدم | كتابة كود تجريبي | ربط دوائر بسيطة + ☀️ | بناء الهيكل | تقييم المواد والطاقة |
| 5-6 | حل المشاكل | برمجة الحساسات + 🔋 | اختبار التوصيلات + الطاقة الشمسية | دمج الإلكترونيات | حساب التوفير والكفاءة |
| 7-8 | تحضير العرض | تحسين الكود | فحص نهائي + 📊 طاقة | اللمسات الأخيرة | إعداد تقرير الأثر البيئي |
